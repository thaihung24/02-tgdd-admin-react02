...
const Themes = () => {
    ...
    useEffect(()=>{
        const themeClass =modeSetting.find(e=>e.class===localStorage.getItem('themeMode','theme-mode-light'))
        const colorClass =modeSetting.find(e=>e.class===localStorage.getItem('colorMode','theme-mode-light'))
